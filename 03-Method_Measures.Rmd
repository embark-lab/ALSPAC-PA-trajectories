...
Cognitive eating disorder features were assessed across age, with a robust
...
At all assessment points, participants reported whether exercise interferes with work/school (14,16,18), or their daily routine (24). At ages 14 and 24, participants also reported whether they exercised to lose weight even when sick or injured. At ages 16 and 18 years, participants also reported whether they felt guilty about missing an exercise session. Responses options for exercise issues were 'No', 'yes - Sometimes', or 'Yes - Frequently'. Maladaptive exercise is defined in accordance with scoring methods outlined in @schaumbergPatternsMaladaptiveExercise2022, and includes exercising for weight loss **sometimes or frequently** and at least one **maladapative exercise indicator** defined as present at each time point.
